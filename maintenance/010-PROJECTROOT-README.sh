...
# dksrc/dk0 import-github-l2 --repo diskuv/dk --tag 2.5.202601180005 --outdir dksrc/etc/dk/i/
# dksrc/dk0 import-github-l2 --repo jonahbeckford/dk --tag 2.5.202601180004 --outdir dksrc/etc/dk/i/
