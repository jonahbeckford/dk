...
- the Unix tarballs have symlinks that can't be handled by 7z on Windows
  ...
  $ get-object CommonsBase_LLVM.Toolchain.MinGW@21.1.8+rev-20251216 -s Release.Linux_arm64 -f ${RUNTIME}/Linux_arm64-Toolchain.MinGW-21.1.8+rev-20251216.zip
  $ get-object CommonsBase_LLVM.Toolchain.MinGW@21.1.8+rev-20251216 -s Release.Linux_x86_64 -f ${RUNTIME}/Linux_x86_64-Toolchain.MinGW-21.1.8+rev-20251216.zip
