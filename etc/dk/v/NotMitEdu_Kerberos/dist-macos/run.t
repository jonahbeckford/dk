```cram
Distribution for NotMitEdu_Kerberos
...
--- Objects and Assets ---
  ...
  $ get-object NotMitEdu_Kerberos.V5@1.22.2 -s Release.Darwin_arm64 -f ${RUNTIME}/Darwin_arm64-V5-1.22.2.zip
  $ get-object NotMitEdu_Kerberos.V5@1.22.2 -s Release.Darwin_x86_64 -f ${RUNTIME}/Darwin_x86_64-V5-1.22.2.zip
