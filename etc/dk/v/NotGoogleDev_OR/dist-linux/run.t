```cram
Distribution for NotGoogleDev_OR
...
--- Rules ---
  ...
  $ post-object NotGoogleDev_OR.Tools@9.15.0 -f ${RUNTIME}/Tools.zip
  >   # TODO: add rule invocations for NotGoogleDev_OR.Tools@9.15.0
