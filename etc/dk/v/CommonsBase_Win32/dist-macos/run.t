```cram
Distribution for CommonsBase_Win32
...
--- Objects and Assets ---
  ...
  $ get-object CommonsBase_Win32.Wine@11.2.0 -s Release.Darwin_x86_64 -f ${RUNTIME}/Darwin_x86_64-Wine-11.2.0.zip
  $ get-object CommonsBase_Win32.Wine@11.2.0 -s Release.Darwin_arm64 -f ${RUNTIME}/Darwin_arm64-Wine-11.2.0.zip
